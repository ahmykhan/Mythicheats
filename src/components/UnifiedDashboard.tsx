...
import { Home, MessageCircle, LogOut, Bell, Download, User } from "lucide-react";
...
const UnifiedDashboard: React.FC<UnifiedDashboardProps> = ({ username, onLogout }) => {
        ...
        <Tabs defaultValue="materials" className="space-y-6">
          ...
          <TabsContent value="chat">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <ChatRoom currentUsername={username} />
            </motion.div>
          </TabsContent>
        </Tabs>
